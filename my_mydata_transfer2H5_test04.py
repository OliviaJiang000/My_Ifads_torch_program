...
def convert_nwb_to_lfads_h5(
    ...
    for unit in tqdm(range(num_units), desc="Binning spikes"):
        ...
        for i in range(num_trials):
            t0 = start_times[i]
            t1 = stop_times[i]
            bin_edges = np.arange(t0, t1+bin_size-0.0001, bin_size)
            ...
            spike_tensor_full[i, :, unit] = counts
...
if __name__ == "__main__":
    ...
    output_h5 = 'myData/my_000128_test04.h5'
    output_yaml = 'configs/datamodule/my_datamodule04_000128.yaml'
